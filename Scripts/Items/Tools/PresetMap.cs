...
//UOSI Modded to hell and back so it won't give out the wrong maps.
//Also so my maps will be named correctly.
namespace Server.Items
{
	...
	public class PresetMapEntry
	{
        ...
        //UOSI - Commented this out so mapmakers won't sell vanilla maps!
