...
namespace Server.Mobiles
{
	...
	public abstract class BaseVendor : BaseCreature, IVendor
	{
		...
		public virtual bool CheckGargoyle()
		{
			...
			if (map != Map.Ilshenar || map != Map.SerpentIsle) 
			{
				return false;
			}

			if (!Region.IsPartOf("Gargoyle City") || !Region.IsPartOf("Town of Furnace") || !Region.IsPartOf("Furnace Cavern"))
			{
				return false;
			}
        ...
        public virtual bool CheckTerMur()
        {
            ...
            if (map != Map.TerMur || Server.Spells.SpellHelper.IsEodon(map, Location) || map != Map.SerpentIsle) //UOSI
                return false;
