...
{
	public class AspectAbilityDeathRay : AspectAbility
	{
		...
		{
			get { return AspectFlags.Tech | AspectFlags.Despair | AspectFlags.Darkness | AspectFlags.Chaos; }
		}
