...
namespace Xanthos.ShrinkSystem
{
	...
	public class ShrinkingHitchingPost : AddonComponent, IShrinkTool
	{
		...
		[Constructable]
		public ShrinkingHitchingPost() : this( 0x14E7 )
		{
		}

		[Constructable]
		public ShrinkingHitchingPost( int itemID ) : base( itemID )
		{
		}

		public ShrinkingHitchingPost( Serial serial ) : base( serial )
		{
		}
	...
	public class HitchingPostEastAddon : BaseAddon
	{
		...
		{
			AddComponent( new ShrinkingHitchingPost( 0x14E7 ), 0, 0, 0);
		}
	...
	public class HitchingPostSouthAddon : BaseAddon
	{
		...
		{
			AddComponent( new ShrinkingHitchingPost( 0x14E8 ), 0, 0, 0);
		}
