...
{complexnamecomponentscode}
	...
	public class {name}AddonDeed : BaseAddonDeed
	{
        ...
        private static void OnAddonGen(CommandEventArgs e)
        {
            ...
            state[12] = state[14] = state[16] = 49150;
                ...
                foreach (object o in en)
                {
                    ...
                    if (getItems)
                    {
                        ...
                        if (i == null)
                            ...
                            continue;
                        else if (i.ItemID < 2 || i.ItemID > 49150) // This is not an Item within the normal artwork.. multi... etc.. Toss it
                            continue;
