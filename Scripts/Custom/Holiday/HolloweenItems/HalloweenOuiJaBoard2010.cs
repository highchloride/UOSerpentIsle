...
{  
	public class HalloweenOuiJaBoard2016 : Item
	{
           	[Constructable]
           	public HalloweenOuiJaBoard2016 ()
           	{
			ItemID = 4013;
           		Name = "a oui-ja board";
			...
			Hue = 1137;
           	...
           	[Constructable]
           	public HalloweenOuiJaBoard2016 (int amount)
           	{
           	}

           	public HalloweenOuiJaBoard2016 (Serial serial) : base( serial )
           	{
           	}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060662, "Halloween\t2016 " );
		}
