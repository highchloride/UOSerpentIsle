	...
	public class SBKeeperOfNecro : SBInfo
	{
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( AnimateDeadScroll ), 137, 20, 0x2260, 0 ) );
				Add( new GenericBuyInfo( typeof( CurseWeaponScroll ), 221, 20, 0x2263, 0 ) );
				//Add( new GenericBuyInfo( typeof( HorrificBeastScroll ), 100, 20, 0x2265, 0 ) );
				Add( new GenericBuyInfo( typeof( PainSpikeScroll ), 245, 20, 0x2268, 0 ) );
				Add( new GenericBuyInfo( typeof( SummonFamiliarScroll ), 170, 20, 0x226B, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( WraithFormScroll ), 212, 20, 0x226F, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( MindRotScroll ), 163, 20, 0x2267, 0 ) );
