...
{
    public class BonusStatAtt200 : XmlAttachment
    {		
		private int StrVar = 50;
		private int DexVar = 50;
		private int IntVar = 50;
			
        public BonusStatAtt200(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt200()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt200(double seconds, double duration)
        {
