...
{
    public class BonusStatAtt180 : XmlAttachment
    {		
		private int StrVar = 45;
		private int DexVar = 45;
		private int IntVar = 45;
			
        public BonusStatAtt180(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt180()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt180(double seconds, double duration)
        {
