...
{
    public class BonusStatAtt30 : XmlAttachment
    {		
		private int StrVar = 22;
		private int DexVar = 22;
		private int IntVar = 22;
		
        public BonusStatAtt30(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt30()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt30(double seconds, double duration)
        {
