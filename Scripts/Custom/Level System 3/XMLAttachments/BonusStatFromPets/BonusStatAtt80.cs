...
{
    public class BonusStatAtt80 : XmlAttachment
    {		
		private int StrVar = 30;
		private int DexVar = 30;
		private int IntVar = 30;
			
        public BonusStatAtt80(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt80()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt80(double seconds, double duration)
        {
