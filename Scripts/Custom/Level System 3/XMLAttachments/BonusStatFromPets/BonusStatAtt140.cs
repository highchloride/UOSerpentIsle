...
{
    public class BonusStatAtt140 : XmlAttachment
    {		
		private int StrVar = 35;
		private int DexVar = 35;
		private int IntVar = 35;
			
        public BonusStatAtt140(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt140()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt140(double seconds, double duration)
        {
