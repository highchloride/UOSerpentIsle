...
{
    public class BonusStatAtt60 : XmlAttachment
    {		
		private int StrVar = 26;
		private int DexVar = 26;
		private int IntVar = 26;
			
        public BonusStatAtt60(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt60()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt60(double seconds, double duration)
        {
