...
{
    public class BonusStatAtt40 : XmlAttachment
    {		
		private int StrVar = 23;
		private int DexVar = 23;
		private int IntVar = 23;
		
        public BonusStatAtt40(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt40()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt40(double seconds, double duration)
        {
