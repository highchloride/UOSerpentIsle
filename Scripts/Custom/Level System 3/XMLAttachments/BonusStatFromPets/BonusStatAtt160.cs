...
{
    public class BonusStatAtt160 : XmlAttachment
    {		
		private int StrVar = 40;
		private int DexVar = 40;
		private int IntVar = 40;
			
        public BonusStatAtt160(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt160()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt160(double seconds, double duration)
        {
