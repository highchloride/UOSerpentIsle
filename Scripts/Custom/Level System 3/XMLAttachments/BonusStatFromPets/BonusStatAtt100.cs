...
{
    public class BonusStatAtt100 : XmlAttachment
    {		
		private int StrVar = 33;
		private int DexVar = 33;
		private int IntVar = 33;
			
        public BonusStatAtt100(ASerial serial) : base(serial)
        {
        }

        [Attachable]
        public BonusStatAtt100()
        {
			Expiration = TimeSpan.FromMinutes(5);
        }

        [Attachable]
        public BonusStatAtt100(double seconds, double duration)
        {
