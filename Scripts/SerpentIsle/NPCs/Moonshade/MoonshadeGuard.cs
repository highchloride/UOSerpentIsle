...
{
    public class MoonshadeGuard : BaseGuard
    {
        ...
        public MoonshadeGuard(Serial serial)
            : base(serial)
        { }
        ...
        {
            private readonly MoonshadeGuard m_Owner;

            public AttackTimer(MoonshadeGuard owner)
        ...
        private class IdleTimer : Timer
        {
            ...
            public IdleTimer(MoonshadeGuard owner)
