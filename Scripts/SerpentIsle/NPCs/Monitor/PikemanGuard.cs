...
{
    public class PikemanGuard : BaseGuard
    {
        ...
        public PikemanGuard(Serial serial)
            : base(serial)
        { }
        ...
        {
            private readonly PikemanGuard m_Owner;

            public AttackTimer(PikemanGuard owner)
        ...
        private class IdleTimer : Timer
        {
            ...
            public IdleTimer(PikemanGuard owner)
