...
namespace Server.Misc
{
    public static class ArchivedSaves
    {
        ...
        public static string Archive(string originDir)
        {
            ...
            //ZipFile.CreateFromDirectory(originDir, Path.Combine(destination, year, month, AutoSave.GetTimeStamp() + ".zip"), CompressionLevel.Optimal, true); //UOSI This doesn't compile?
