...
namespace Server.Misc
{
    public class Weather
    {
        ...
        //public accessor for Active - UOSI
        public bool Active
        {
            get { return m_Active; }
            set { m_Active = value; }
        ...
        //UOSI: Removed all facets from the Map array
        //Removed all weathers except the Dynamic weather so I can always get the Active setting for the XMLSpawner 'RequireRaining' parameter
        public static void Initialize() 
        {
            m_Facets = new Map[] { Map.SerpentIsle }; //Map.Felucca, Map.Trammel, Map.SerpentIsle, Map.Tokuno
            ...
            */
            ...
            //This loop is for the middle band, 50% chance of snow
            for (int i = 0; i < 5; ++i)
                AddDynamicWeather(10, Utility.Random(75, 90), 50, Utility.Random(8, 80), Utility.Random(50, 150), Utility.Random(50, 150), new Rectangle2D(0, 600, 1412, 200));

            //And this covers the rest of the island, all rain
            for (int i = 0; i < 5; ++i)
                AddDynamicWeather(20, Utility.Random(75, 90), 5, 0, Utility.Random(200, 400), Utility.Random(200, 400), new Rectangle2D(0, 800, 1412, 1600));
        }
