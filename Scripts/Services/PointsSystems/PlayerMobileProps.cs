...
namespace Server.Mobiles
{
    ...
    public class CityLoyaltyProps
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public CityLoyaltyEntry Monitor
        {
            get
            {
                return CityLoyaltySystem.Monitor.GetPlayerEntry<CityLoyaltyEntry>(Player);
            }
            set { }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public CityLoyaltyEntry Fawn
        {
            get
            {
                return CityLoyaltySystem.Fawn.GetPlayerEntry<CityLoyaltyEntry>(Player);
            }
            set { }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public CityLoyaltyEntry Moonshade
        {
            get
            {
                return CityLoyaltySystem.Moonshade.GetPlayerEntry<CityLoyaltyEntry>(Player);
            }
            set { }
        }
