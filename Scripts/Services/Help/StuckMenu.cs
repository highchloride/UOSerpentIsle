...
namespace Server.Menus.Questions
{
    ...
    public class StuckMenu : Gump
    {
        ...
        {
            //UOSI Updated to send to the right cities
            //Monitor
            new StuckMenuEntry(1011028, new Point3D[]
            {
                new Point3D(355,1434,0),
                new Point3D(347,1437,0),
                new Point3D(331,1428,0),
                new Point3D(333,1436,0),
                new Point3D(340,1436,0)
            }),

            //Fawn
            new StuckMenuEntry(1011029, new Point3D[]
            {
                new Point3D(407, 1033, 0),
                new Point3D(407, 1021, 0),
                new Point3D(417, 1020, 0),
                new Point3D(419, 1026, 0),
                new Point3D(418, 1035, 0)
            }),

            //Moonshade
            new StuckMenuEntry(1011030, new Point3D[]
            {
                new Point3D(1190, 1115, 0),
                new Point3D(1190, 1118, 0),
                new Point3D(1194, 1119, 0),
                new Point3D(1194, 1115, 0),
                new Point3D(1190, 1123, 0)
            }),

            //Sleeping Bull
            new StuckMenuEntry(1011031, new Point3D[]
            {
                new Point3D(540, 1204, 0),
                new Point3D(540, 1203, 0),
                new Point3D(540, 1202, 0),
                new Point3D(540, 1201, 0),
                new Point3D(540, 1200, 0)
            })
        ...
        private class TeleportTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                else
                {
                    ...
                    else if (m_Mobile.Map == Map.SerpentIsle)
                        destMap = Map.SerpentIsle;
                    else
