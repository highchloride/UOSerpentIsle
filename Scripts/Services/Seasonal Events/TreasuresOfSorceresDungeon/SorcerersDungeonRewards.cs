...
namespace Server.Engines.SorcerersDungeon
{
    public static class SorcerersDungeonRewards
    {
        ...
        public static void Initialize()
        {
            ...
            //Rewards.Add(new CollectionItem(typeof(SerpentJawbone), 0x9F74, 1157654, 0, 50)); //UOSI Changed this to my jawbone, but it should probably not be anything. So now it's not.
